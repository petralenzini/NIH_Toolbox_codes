...
#HARVARD DIDN"T FOLLOW SOP.  NOTHING NEW TO ADD this time (two files in incorporated--neither resolved)
...
umnafiles2, umnafolders2=folderlistcontents(umnafolders.loc[~(umnafolders.foldername=='incorporated_10Dec2019')].foldername,umnafolders.loc[~(umnafolders.foldername=='incorporated_10Dec2019')].folder_id)
